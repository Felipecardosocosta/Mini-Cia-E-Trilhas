...
const buscarInfosDashBord = async(token) => {
    if (!token) {
    ...
    try {
        ...
        const result = await axios.get("https://api-mine-cia.vercel.app/buscar/dados/dashbord",{headers:{Authorization: token}})
...
export default buscarInfosDashBord